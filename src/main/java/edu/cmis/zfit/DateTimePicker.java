...
public class DateTimePicker extends DatePicker {
    ...
    public static DateRange getDateRange(LocalDateTime beginDate, LocalDateTime endDate) {
        Instant instantStart = beginDate.toInstant(zoneOffset).truncatedTo(ChronoUnit.MINUTES);
        Instant instantEnd = endDate.toInstant(zoneOffset).truncatedTo(ChronoUnit.MINUTES);

        return new DateRange(instantStart, instantEnd);
    }
